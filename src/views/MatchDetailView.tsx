    ...
    <div className="w-full flex flex-col gap-6 animate-fade-in pb-8 pt-4 md:pt-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="xl:col-span-1 flex flex-col gap-4">
          ...
          {match.odds && (() => {
            const o = match.odds;
            const ft = o.full_time;
            const hasFt = ft && (ft.home != null || ft.draw != null || ft.away != null);
            ...
            return (
              <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-emerald-500/10 text-emerald-400 flex items-center justify-center border border-emerald-500/20 text-xs">💰</span>
                  <h3 className="text-sm font-bold text-slate-200">Cuotas</h3>
                </div>
                {/* 1X2 */}
                <div className="flex flex-col gap-1">
                  <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Resultado final (1X2)</span>
                  <div className="grid grid-cols-3 gap-1.5">
                    <div className="flex flex-col items-center bg-emerald-500/5 border border-emerald-500/15 rounded-xl p-2">
                      <span className="text-[9px] text-slate-500 font-bold mb-0.5">1</span>
                      <span className="text-sm font-black text-emerald-400">{fmt(ft?.home)}</span>
                    </div>
                    <div className="flex flex-col items-center bg-white/[0.03] border border-white/5 rounded-xl p-2">
                      <span className="text-[9px] text-slate-500 font-bold mb-0.5">X</span>
                      <span className="text-sm font-black text-slate-300">{fmt(ft?.draw)}</span>
                    </div>
                    <div className="flex flex-col items-center bg-indigo-500/5 border border-indigo-500/15 rounded-xl p-2">
                      <span className="text-[9px] text-slate-500 font-bold mb-0.5">2</span>
                      <span className="text-sm font-black text-indigo-400">{fmt(ft?.away)}</span>
                    </div>
                  </div>
                </div>
                {/* Doble Oportunidad */}
                {o.double_chance && (
                  <div className="flex flex-col gap-1">
                    <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Doble Oportunidad</span>
                    <div className="grid grid-cols-3 gap-1.5">
                      {o.double_chance.home_draw != null && <div className="flex flex-col items-center bg-amber-500/5 border border-amber-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">1X</span><span className="text-xs font-black text-amber-400">{fmt(o.double_chance.home_draw)}</span></div>}
                      {o.double_chance.draw_away != null && <div className="flex flex-col items-center bg-amber-500/5 border border-amber-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">X2</span><span className="text-xs font-black text-amber-400">{fmt(o.double_chance.draw_away)}</span></div>}
                      {o.double_chance.home_away != null && <div className="flex flex-col items-center bg-amber-500/5 border border-amber-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">12</span><span className="text-xs font-black text-amber-400">{fmt(o.double_chance.home_away)}</span></div>}
                    </div>
                  </div>
                )}
                {/* DNB + BTTS en fila */}
                {(o.draw_no_bet || o.btts) && (
                  <div className="grid grid-cols-2 gap-2">
                    {o.draw_no_bet && (
                      <div className="flex flex-col gap-1">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">DNB</span>
                        <div className="flex gap-1.5">
                          {o.draw_no_bet.home != null && <div className="flex flex-col items-center flex-1 bg-cyan-500/5 border border-cyan-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">1</span><span className="text-xs font-black text-cyan-400">{fmt(o.draw_no_bet.home)}</span></div>}
                          {o.draw_no_bet.away != null && <div className="flex flex-col items-center flex-1 bg-cyan-500/5 border border-cyan-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">2</span><span className="text-xs font-black text-cyan-400">{fmt(o.draw_no_bet.away)}</span></div>}
                        </div>
                      </div>
                    )}
                    {o.btts && (
                      <div className="flex flex-col gap-1">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">BTTS</span>
                        <div className="flex gap-1.5">
                          {o.btts.yes != null && <div className="flex flex-col items-center flex-1 bg-purple-500/5 border border-purple-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">Sí</span><span className="text-xs font-black text-purple-400">{fmt(o.btts.yes)}</span></div>}
                          {o.btts.no != null && <div className="flex flex-col items-center flex-1 bg-purple-500/5 border border-purple-500/15 rounded-xl p-2"><span className="text-[9px] text-slate-500 font-bold mb-0.5">No</span><span className="text-xs font-black text-purple-400">{fmt(o.btts.no)}</span></div>}
                        </div>
                      </div>
                    )}
                  </div>
