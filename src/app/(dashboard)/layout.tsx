...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const isCS2 = pathname.startsWith('/cs2');
                  ...
                  <>
                    ...
                    <div className="w-16 flex-shrink-0 relative h-12 flex items-center justify-center">
                      <Link
                        ...
                        className={`
                          absolute -top-7 w-16 h-16 rounded-full flex items-center justify-center border-4 border-[#121212] shadow-lg transition-all duration-200 active:scale-90 cursor-pointer
                          ${isPartidosActive
